...
//	@RequiresPermissions("sys:user:save")
    public R save(@RequestBody SysUserEntity user) {
        ...
        if (roleId == 3) {
            ...
            teacherEntity.setId(user.getUsername());
            teacherEntity.setTeacherNum(user.getMobile());
            teacherService.save(teacherEntity);
        } else if (roleId == 2) {
            StudentEntity studentEntity = new StudentEntity();
            studentEntity.setId(user.getUsername());
            studentEntity.setStudentNum(user.getMobile());
...
//	@RequiresPermissions("sys:user:delete")
    ...
    public R deleteByStudentId(@RequestBody String[] ids) {
        List<String> userIds = sysUserService.getIdByUserName(ids);
    ...
    public R deleteByTeacherId(@RequestBody String[] ids) {
        List<String> userIds = sysUserService.getIdByUserName(ids);
        sysUserService.removeByIds(userIds);
        return R.ok();
    }
